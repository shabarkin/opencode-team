...
export const Flag = {
  ...
  get OPENCODE_EXPERIMENTAL_AGENT_TEAMS() {
    return truthy("OPENCODE_EXPERIMENTAL") || truthy("OPENCODE_EXPERIMENTAL_AGENT_TEAMS")
  },
  get OPENCODE_EXPERIMENTAL_AGENT_TEAMS_WORKTREES() {
