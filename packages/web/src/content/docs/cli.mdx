...
| `--worktrees` |       | Enable isolated teammate git worktrees after Agent Teams are enabled    |
...
| `OPENCODE_EXPERIMENTAL_AGENT_TEAMS`             | boolean | Enable experimental Agent Teams         |
| `OPENCODE_EXPERIMENTAL_AGENT_TEAMS_WORKTREES`   | boolean | Use isolated worktrees for Agent Teams  |
