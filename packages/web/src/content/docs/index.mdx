...
:::note
This fork also includes an experimental Agent Teams workflow for coordinated multi-session work.
Enable it with `OPENCODE_EXPERIMENTAL_AGENT_TEAMS=1` and start with [Agent Teams](/docs/agent-teams), [Worktrees](/docs/worktrees), and [Steering](/docs/steering).
:::
