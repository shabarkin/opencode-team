...
| Area | Files |
| ---- | ----- |
| Normal session steering | `packages/opencode/src/server/routes/session.ts`, `packages/opencode/src/session/prompt.ts` |
| Team steering routes | `packages/opencode/src/server/routes/team.ts` |
...
| Header and prompt wiring | `packages/opencode/src/cli/cmd/tui/routes/session/header.tsx`, `packages/opencode/src/cli/cmd/tui/component/prompt/index.tsx`, `packages/opencode/src/cli/cmd/tui/routes/session/index.tsx` |
| Team state refresh | `packages/opencode/src/cli/cmd/tui/context/sync.tsx`, `packages/opencode/src/server/routes/event.ts` |
