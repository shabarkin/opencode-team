...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const teamInfos = Flag.OPENCODE_EXPERIMENTAL_AGENT_TEAMS ? yield* Effect.all(TeamTools) : []
      ...
      Effect.fn("ToolRegistry.state")(function* (ctx) {
        ...
        return {
          ...
          builtin: [
            ...
            ...(yield* Effect.all(
              teamInfos.map((info) =>
                Tool.init(info as unknown as Tool.Info<Schema.Decoder<unknown>, Record<string, unknown>>),
              ),
            )),
          ],
          task: tool.task,
