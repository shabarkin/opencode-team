...
function withAgentTeams<A, E, R>(fx: () => Effect.Effect<A, E, R>) {
  return Effect.acquireUseRelease(
    Effect.sync(() => {
...
function syntheticText(parts: ReadonlyArray<MessageV2.Part>) {
  return parts
...
noLLMServer.instance(
  "prefers team tools for explicit team requests with agent mentions",
  () =>
    withAgentTeams(() =>
      Effect.gen(function* () {
        const prompt = yield* SessionPrompt.Service
...
noLLMServer.instance(
  "keeps task hints for non-team agent mentions",
  () =>
    withAgentTeams(() =>
      Effect.gen(function* () {
        const prompt = yield* SessionPrompt.Service
...
noLLMServer.instance(
  "does not switch to team hints for generic team wording",
  () =>
    withAgentTeams(() =>
      Effect.gen(function* () {
        const prompt = yield* SessionPrompt.Service
